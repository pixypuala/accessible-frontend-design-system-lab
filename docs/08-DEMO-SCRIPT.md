# Demo Script — Accessible Frontend Design System Lab
...
Show the extracted public package `block-a11y-pattern-lab`, contribution path, and one beginner-friendly issue.
